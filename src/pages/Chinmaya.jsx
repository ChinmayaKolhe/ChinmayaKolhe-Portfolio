      ...
      <section id="home" className="hero">
        <div className="hero-container">
          ...
          <div className="hero-content">
            ...
            <p>Pre-final year B.Tech in Information Technology student with expertise in full-stack web and mobile development. Proficient in MERN stack, Java, Python, and Android development.</p>
          ...
          <div className="experience-grid">
            <div className="experience-card">
              ...
              <ul className="experience-details">
                <li>Developed a personalized learning platform with quiz modules, assessment workflows, and real-time student-faculty interaction</li>
                <li>Enabled seamless internal communication and academic tracking</li>
              </ul>
            </div>
            ...
            <div className="experience-card">
              ...
              <ul className="experience-details">
                <li>Designed backend architecture for a Quiz App including APIs, database schemas, and contest logic</li>
                <li>Implemented user registration, secure login, and leaderboard modules using Node.js and MongoDB</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          ...
          <div className="skills-grid">
            ...
            {[
              ...
              {name: 'Data Science', logo: 'https://cdn-icons-png.flaticon.com/512/3037/3037996.png' }
            ].map((skill, index) => (
            ...
            {[
              {
                ...
                description: 'Web-based platform assisting farmers with loan eligibility, AI-driven predictions, and marketplace.',
              ...
              },
              {
                ...
                description: 'Web-based assessment and communication tool for PCCOE\'s Dean Office.',
                tech: 'React.js, Node.js, Express, MongoDB',
                github: 'https://github.com/ChinmayaKolhe/Learning-Tool-Frontend'
              },
              {
                title: 'RecycleEase – Android E-Waste Management App',
                description: 'Android app for responsible e-waste handling with pickup requests and donation services.',
        ...
        <div className="container">
          ...
          <div className="contact-container">
            ...
            <div className="contact-info">
              ...
              <a href="https://github.com/ChinmayaKolhe" target="_blank" rel="noopener noreferrer">
                <i className="fab fa-github"></i> GitHub
              </a>
              <a href="https://www.linkedin.com/in/chinmaya-kolhe-34165524a/" target="_blank" rel="noopener noreferrer">
